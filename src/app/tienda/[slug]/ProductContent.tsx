      ...
      <div className="pt-24 pb-16 px-6">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="aspect-[4/5] skeleton-gold rounded-sm" />
            <div className="space-y-4">
              <div className="h-5 w-20 skeleton-gold rounded-sm" />
              <div className="h-12 w-3/4 skeleton-gold rounded-sm" />
              <div className="h-8 w-28 skeleton-gold rounded-sm" />
              <div className="h-20 w-full skeleton-gold rounded-sm" />
              <div className="h-12 w-full skeleton-gold rounded-sm mt-8" />
            </div>
          </div>
        </div>
      </div>
            ...
            >
              {product.images[selectedImage] ? (
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <span className="font-display text-8xl text-gold/10">MR</span>
                </div>
              )}
              <div className="urban-card-grain" />

              {totalStock <= 0 && (
                <div className="urban-badge urban-badge-soldout absolute top-4 left-4 z-10">
                  ...
                  {uniqueColors.map((color) => {
                    ...
                    return (
                      <button
                        ...
                        className={`urban-color-swatch w-[34px] h-[34px] rounded-full cursor-pointer ${isActive ? "active" : ""}`}
                  ...
                  {sizesForColor.map((v) => {
                    ...
                    return (
                      <button
                        ...
                        disabled={v.stock <= 0}
                        className={`urban-size-btn rounded-sm ${selectedVariant === globalIdx ? "active" : ""}`}
                      >
                        {v.size}
                      </button>
                    );
