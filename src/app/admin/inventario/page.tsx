              ...
              >
                <div className="p-4 bg-surface/50 border-b border-border flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] text-offwhite/30 font-mono">{group.productSlug}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-display text-gold tracking-[1px]">
                      {totalStock(group.variants)}
                    </p>
                    <p className="text-[10px] text-offwhite/30 font-mono uppercase tracking-[1px]">
                      Total stock
                    </p>
                  </div>
                </div>
                        ...
                        return (
                          ...
                          >
                            <td className="p-3 pl-4">
                              <span className="text-xs font-mono text-offwhite/50">
                                {variant.sku}
                              </span>
                            </td>
                            <td className="p-3">
                              <span className="text-xs text-offwhite/70">{variant.size}</span>
                            </td>
                            <td className="p-3">
                              <div className="flex items-center gap-2">
                                ...
                                />
                                <span className="text-xs text-offwhite/70">{variant.color}</span>
                              </div>
                            </td>
                            <td className="p-3">
                              {editingId === variant.id ? (
                                <div className="flex items-center gap-2">
                                  <input
                                    ...
                                    min={0}
                                    autoFocus
                                    className="w-20 px-2 py-1 bg-surface border border-gold/50 rounded-sm text-sm text-offwhite/80 focus:outline-none"
                                  />
                                  <button
                                    onClick={() => saveStock(variant.id)}
                                    disabled={saving}
                                    className="text-[10px] font-mono uppercase tracking-[1px] text-gold hover:text-gold-light disabled:opacity-30 transition-colors"
                                  >
                                    {saving ? "..." : "Guardar"}
                                  </button>
                                  <button
                                    onClick={() => setEditingId(null)}
                                    className="text-[10px] font-mono uppercase tracking-[1px] text-offwhite/30 hover:text-offwhite/50 transition-colors"
                                  >
                                    Cancelar
                                  </button>
                                </div>
