      ...
      {toasts.map((toast) => (
        <div
          ...
          style={{
            ...
            borderColor: toast.type === "error" ? "rgba(255,60,47,0.3)" : toast.type === "info" ? "rgba(201,168,76,0.3)" : "rgba(74,222,128,0.3)",
            color: toast.type === "error" ? "#ff6b5e" : toast.type === "info" ? "#C9A84C" : "#86efac",
          }}
          role="alert"
        >
